...
@section('content')
        <div class="page-header page-header-small">
            <div class="page-header-image" data-parallax="true" style="background-image: url('{{asset('now-ui-kit-v1.1.0/assets/img/bg6.jpg')}}');">
            </div>
            <div class="container">
        ...
        <div class="section section-about-us">
            <div class="container">
                ...
                <div class="section-story-overview">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="image-container image-left" style="background-image: url('{{asset('now-ui-kit-v1.1.0/assets/img/login.jpg')}}')">
